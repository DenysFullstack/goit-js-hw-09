...
// setInterval(()=>{
//   let timeLeft = millisecondsDifference - 1000;
...
//     qtDays.textContent = currentDate;
//     qtHours.textContent = currentHours;
//     qtMinutes.textContent = currentMinutes;
//     qtSeconds.textContent = currentSeconds;
